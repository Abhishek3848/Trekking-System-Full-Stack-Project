...
function MyOrders() {
    ...
    useEffect(() => {
        axios.get("http://localhost:9999/orders?custid=" + sessionStorage.getItem("id"))
            .then(resp => {
    ...
    const showDetails = (orderid) => {
        axios.get("http://localhost:9999/orders/" + orderid)
            .then(resp => {
                console.log(resp.data)
                                        ...
                                        <tbody>
                                            {details.map(x => (
                                                <tr key={x.event.eventid}>
                                                    ...
                                                    <td>
                                                        <img className="mr-2" src={"http://localhost:9999/" + x.event.photo1} width="100" alt="event" />
