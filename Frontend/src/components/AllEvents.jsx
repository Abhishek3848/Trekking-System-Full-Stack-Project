...
function AllEvents() {
    ...
    const loadDataFromServer = (page = 0, pagesize = 8) => {
        axios.get(`http://localhost:8888/events/paginated?page=${page}&pagesize=${pagesize}`)
            .then(resp => {
    ...
    useEffect(() => {
        ...
        if (eventcat.cat !== undefined) {
            axios.get(`http://localhost:8888/events?cat=${eventcat.cat}`)
                .then(resp => {
              ...
              <div className="modal-body">
                <div className="row">
                  <div className="col-md-6">
                    <img src={`http://localhost:8888/${item.photo1}`} className="img-fluid rounded" alt="Event" />
                  </div>
                  <div className="col-md-6">
